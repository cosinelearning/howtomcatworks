package exec3connector.connector.http;
...
import exec3connector.connector.ResponseStream;
import exec3connector.connector.ResponseWriter;
	...
	*/
	    ...
	    synchronized (cookies) {
	      ...
	      while (items.hasNext()) {
	        ...
	        //cosine not sure why
	        //outputWriter.print(CookieTools.org.apache.tomcat.util.http(cookie));
	        //outputWriter.print(": ");
